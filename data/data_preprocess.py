...
def preprocess_got10k(path):
    ...
    _, _, text_encoder, _ = get_model_scope_t2v_models(
        "/staging/leuven/stg_00116/modelscope/text-to-video", 
        )
...
if __name__ == "__main__":
    path = "/data/leuven/333/vsc33366/projects/Diffusion-Video/dataset/youvis/val"
    #preprocess_youvis(path)
    #path = "/data/leuven/333/vsc33366/projects/Diffusion-Video/dataset/got-10k"
    #preprocess_got10k(path)
